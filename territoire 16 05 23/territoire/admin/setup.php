...
print '<td><label for="active">'.  $langs->trans("active") . '</label>'. $langs->trans("active") .'</td>';
print '</tr>';
print '<tr>';
...
print '<option value="1">' . $langs->trans("active").'</option>';
print '<option value="0">' . $langs->trans("inactive").'</option></select></td>';
...
if ($resql)
{
    ...
    if ($num)
    {
        ...
        while ($i < $num)
        {
            ...
            //         {
            //             print '<a href="'.$_SERVER['PHP_SELF'].'?action=' . $acts[0] . '&rowid='.$obj->rowid.'">'.img_picto($langs->trans("Disabled"),'switch_off').'</a>';
            //         }
            //         else
            //         {
            //             print '<a href="'.$_SERVER['PHP_SELF'].'?action=' . $acts[1] . '&rowid='.$obj->rowid.'">'.img_picto($langs->trans("Enabled"),'switch_on').'</a>';
            //         }
            //     }
            //     print '</td>';
            ...
            // print '<td>';
            // print '<a href="'.$_SERVER['PHP_SELF'].'?action=' . $acts[$obj->active] . '&rowid='.$obj->rowid.'">'.$actl[$obj->active].'</a>';
