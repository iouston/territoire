...
CREATE TABLE `llx_c_tranches_metre_departements` (
  `rowid` int(11) NOT NULL,
  `fk_transporteur` int(11) NOT NULL DEFAULT 0,
  `fk_zone` int(11) NOT NULL DEFAULT 0,
  `linear_min` double(24,8) NOT NULL DEFAULT 0.00000000,
  `linear_max` double(24,8) NOT NULL DEFAULT 0.00000000,
  ...
  `import_key` varchar(14) NOT NULL,
  `linear_reel` int(11) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;


ALTER TABLE `llx_c_tranches_metre_departements`
