...
print '<td>';
print $form-> selectyesno($htmlname = 'active', $value='1', $option=1, $disabled=false, $useempty=0, $addjscombo=0, $morecss='', $labelyes=$langs->trans("Yes"), $labelno=$langs->trans("No"));
print '</td>';
