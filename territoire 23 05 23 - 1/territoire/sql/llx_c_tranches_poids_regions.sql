...
-- ============================================================================
 ...
 CREATE TABLE `llx_c_tranches_poids_regions` (
  ...
  `roundsup10` tinyint(4) NOT NULL DEFAULT 0,
  `div100` tinyint(4) NOT NULL DEFAULT 0,
...
--
-- Index pour la table `llx_c_tranches_poids_regions`
--
ALTER TABLE `llx_c_tranches_poids_regions`
...
--
-- AUTO_INCREMENT pour la table `llx_c_tranches_poids_regions`
--
ALTER TABLE `llx_c_tranches_poids_regions`
