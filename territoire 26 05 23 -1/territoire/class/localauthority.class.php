...
/**
 *  \file       htdocs/territoire/class/localauthority.class.php
 *  \ingroup    territoire
 *  \brief      File of class to manage predefined local authorities sets
 */
...
/**
 * Class to manage local authorities ("intercommunalités")
 */
class LocalAuthority extends CommonObject
{
	...
	*/
	...
	/**
	 *  Delete a local authority set from database 
	 *
	...
	/**
	 *  Update the 'active' column from a local authority set in memory from database: set active
	 *
	 *  @param	int		$rowid      			Id of the local authority to load
	 */
	function setActive($rowid)
	{
		$sql = "UPDATE ".MAIN_DB_PREFIX."c_territoire_collectivites SET active = 1 WHERE rowid='".$rowid."'";
	...
	/**
	 *  Update the 'active' column from a local authority set in memory from database: set inactive
	 *
	 *  @param	int		$rowid      			Id of the local authority to load
	 */
	function setInactive($rowid)
	{
		$sql = "UPDATE ".MAIN_DB_PREFIX."c_territoire_collectivites SET active = 0 WHERE rowid='".$rowid."'";
	...
	/**
	 *  Load all the local authorities set in memory from database
	 *
	 *  @return array     					
	 */
	function fetchAll()
